...
class BloodStation(Model):
    ...
    def __init__(self, id: int=None, name: str=None):
        ...
        :type id: int
        :param name: The name of this BloodStation.
        :type name: str
        """
        self.swagger_types = {
            'id': int,
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'BloodStation':
        """
    ...
    def name(self) -> str:
        """
        Gets the name of this BloodStation.

        :return: The name of this BloodStation.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name: str):
        """
        Sets the name of this BloodStation.
